...
public class DECRYPTION {
	...
	public void Decry(ArrayList<Integer> bit_key_8, ArrayList<Integer> k1, ArrayList<Integer> k2,
		...
		Ip_result(ip_list, bit_key_8);

		ip_result = ip;
		left_key = Left_Key_Create(ip);
		right_key = Right_Key_Create(ip);
		Fk();
		xor = Xor(e_p__result, k2);
		left_key1 = Left_Key_Create(xor);
		right_key1 = Right_Key_Create(xor);
		S_result(left_key1, right_key1);
		P4();
		Endfk();
		...
		left_key = Left_Key_Create(this.bit_key_8);
		right_key = Right_Key_Create(this.bit_key_8);
		Ip_result(e_p, this.bit_key_8);
		Fk();
		xor = Xor(e_p__result, k1);
		left_key1 = Left_Key_Create(xor);
		right_key1 = Right_Key_Create(xor);
		S_result(left_key1, right_key1);
		P4();
	...
	public DECRYPTION(ArrayList<Integer> result1) {
	...
	private void S_result(ArrayList<Integer> left_key12, ArrayList<Integer> right_key12) {
		...
		line_result.add(Line_seach(left_key12, 0));
		line_result.add(Line_seach(right_key12, 1));
